...
export default function Header(props) {
  return (
    <header>
      <h1><Link to='/' onClick={props.resetForm}><img src="https://github.com/PurpleTatsu/Lingo/blob/new-master/client/src/images/lingo%20logo.png?raw=true" className="lingo-logo" alt="lingo-logo" /></Link></h1>
